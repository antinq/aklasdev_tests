...
public class Login {
    ...
    @Given("^I entered to \"([^\"]*)\"$")
    public void i_entered_to(String arg1) {
        elements.openBrowser();
        elements.goToPage(arg1);
    }

    @When("^opened \"([^\"]*)\"$")
    public void opened(String arg1) {
        elements.openPage(arg1);
    }
...
//    @When("^I enter \"([^\"]*)\" to textfield Username or email adress$")
//    public void i_enter_to_textfield_Username_or_email_adress(String arg1){
//        elements.enterTextToFieldByCssSelector("#login_field", arg1);
//    }
//
